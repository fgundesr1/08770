...
'<div class="my_account">' +
    ...
    '<svg class="icon-down" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="26px" height="26px" viewBox="0 0 292.362 292.362" style="enable-background:new 0 0 292.362 292.362;" xml:space="preserve">' +
    ...
    '<ul>' +
        ...
        '<li class="registerAccount"><a href="/conta/criar">Cliente novo? Cadastre-se</a></li>' +
    '</ul>' +
'</div>'+
